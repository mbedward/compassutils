...
This package provides some simple functions for working with map and compass bearings. In particular, it tries to help avoid any confusion between compass angles, where 0 degrees is north and positive angles proceed clockwise, and Cartesian angles where zero is the direction of the positive X-axis and angles proceed anti-clockwise. Compass angles are almost always expressed in degrees while Cartesian angles are generally expressed in radians. The standard trigonometric functions in R such as `sin`, `cos` and `atan2` assume you are working with Cartesian angles, not compass bearings.
